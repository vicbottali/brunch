...
import './BrunchDaoToken.sol';

contract BrunchDaoFactory {
    BrunchDaoToken[] public tokens; //an array that contains different ERC1155 tokens deployed
    ...
    */
    function deployERC1155(string memory _contractName, string memory _uri, uint[] memory _ids, string[] memory _names) public returns (address) {
        BrunchDaoToken t = new BrunchDaoToken(_contractName, _uri, _names, _ids);
        tokens.push(t);
    ...
    */
    ...
    {
        BrunchDaoToken token = tokens[_index];
